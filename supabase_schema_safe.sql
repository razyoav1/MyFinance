-- Safe schema: uses IF NOT EXISTS so it can be run multiple times without errors
...
drop policy if exists "users_own_investment_holdings" on investment_holdings;
...
drop policy if exists "users_own_investment_price_history" on investment_price_history;
...
drop policy if exists "users_own_mortgages" on mortgages;
...
drop policy if exists "users_own_mortgage_payments" on mortgage_payments;
...
drop policy if exists "users_own_goal_contributions" on goal_contributions;
...
drop policy if exists "users_own_net_worth_snapshots" on net_worth_snapshots;
...
drop policy if exists "users_own_bank_accounts" on bank_accounts;
