...
export const DEFAULT_CATEGORIES: Omit<Category, 'id'>[] = [
  ...
  { name: 'Donation',        icon: '🎗️', color: '#f43f5e', type: 'expense', isSystem: true, tier: 'lifestyle' },
  ...
  { name: 'Self development', icon: '🧠', color: '#a855f7', type: 'expense', isSystem: true, tier: 'essential' },
